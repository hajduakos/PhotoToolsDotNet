...
namespace FilterLib.Tests.FilterTests
{
    ...
    public class OtherTests
    {
        internal static IEnumerable<TestCaseData> Data()
        {
            ...
            yield return new TestCaseData("_input.bmp", "_input.bmp",
                new WavesFilter(Size.Relative(1), Size.Absolute(0), Direction.Horizontal), 1);
            yield return new TestCaseData("_input.bmp", "_input.bmp",
                new WavesFilter(Size.Relative(.5f), Size.Absolute(0), Direction.Vertical), 1);
            yield return new TestCaseData("_input.bmp", "Waves_50pct_9px_Horizontal.bmp",
                new WavesFilter(Size.Relative(.5f), Size.Absolute(9), Direction.Horizontal), 1);
            yield return new TestCaseData("_input.bmp", "Waves_10pct_16px_Vertical.bmp",
                new WavesFilter(Size.Relative(.1f), Size.Absolute(16), Direction.Vertical), 1);
        }
        internal static IEnumerable<TestCaseData> Exceptions()
        {
            yield return new TestCaseData("_input.bmp", "_input.bmp",
                new WavesFilter(Size.Absolute(0), Size.Relative(1), Direction.Horizontal));
            yield return new TestCaseData("_input.bmp", "_input.bmp",
                new WavesFilter(Size.Relative(0), Size.Relative(1), Direction.Horizontal));
        }
